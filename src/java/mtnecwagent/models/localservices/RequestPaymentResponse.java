 ...
 */
package mtnecwagent.models.localservices;
...
public class RequestPaymentResponse {   
    ...
    private Integer responderStatus;
      ...
      @XmlElement(name="SPTXREFERENCETX")
    private String spTxReferenceTx;
    ...
    /**
     * @return the spTxReferenceTx
     */
    public String getSpTxReferenceTx() {
        return spTxReferenceTx;
    }

    /**
     * @param spTxReferenceTx the spTxReferenceTx to set
     */
    public void setSpTxReferenceTx(String spTxReferenceTx) {
        this.spTxReferenceTx = spTxReferenceTx;
    }
}
